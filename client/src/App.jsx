  ...
  return (
    <div className="flex h-screen flex-col bg-slate-100 text-slate-900">
      ...
      <div className="flex flex-1 flex-col overflow-hidden md:flex-row">
        ...
        <aside className="flex max-h-[55vh] w-full flex-shrink-0 flex-col gap-4 overflow-y-auto border-l border-slate-200 bg-white p-4 md:h-full md:max-h-full md:w-96">
          {error && (
